-- WA Manager — schema inicial (Postgres / prod). Espelho de migrations/sqlite/001_init.sql.
-- Mesmas convenções portáveis: id TEXT (UUID gerado no app), timestamps TEXT (ISO 8601),
